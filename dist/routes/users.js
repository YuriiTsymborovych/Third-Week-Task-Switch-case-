...
function verifyToken(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (token) {
            ...
            const expires = decodedToken === null || decodedToken === void 0 ? void 0 : decodedToken.payload.exp;
            const expiresInMiliseconds = expires * 1000;
            let date = Date.now();
            console.log(date - expiresInMiliseconds);
            console.log(expiresInMiliseconds);
            console.log(date);
            const neededUser = yield User.findOne({ _id: sub });
            if (neededUser) {
                // if(date > expiresInMiliseconds){
...
router.post('/login', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (isValid) {
            ...
            res.cookie('jwtToken', tokenObject, { maxAge: 20 * 1000, httpOnly: true, secure: true });
